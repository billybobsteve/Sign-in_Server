...
switch ($option) {
	case "out_students" :
		...
		//echo "<h1>Students</h1>";
		echo "Name: <input class='text-box' id='name' type='text'>" . "Location: <input class='text-box' id='dest' type='text'>" . "Time Out: <input class='text-box' id='time_out' type='text'>"
		 . "Server Time Out: <input class='text-box' id='server_time_out' type='text'>"
		 . "Time In: <input class='text-box' id='time_in' type='text'>"
		 . "Server Time In: <input class='text-box' id='server_time_in' type='text'>";
		echo "<table border='0'>";
