var insert_overlay = function() {
	...
	if (zIndex < 0) {
		...
		$("#confirmation").html('You have successfully been signed out. <div style="font-size:18px;color:#FFFFFF;opacity:.55;">Click anywhere to dismiss this notification.</div>');
